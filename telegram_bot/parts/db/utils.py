...
def init_db(db_path, sql_file_path):
    '''
    :db_path: path to the .db file
    :sql_file_path: a .sql file with SQL statements that will create the database base tables
    '''
    ...
    try:
        ...
        logger.exception('An Exception occured while trying to open and read SQL statements(sql_file_path) file.')
        return False
    ...
    try:
        ...
        logger.exception('An Exception occured while trying to execute the SQL statements.')
        return False
...
def get_connection(db_path):
    try:
        ...
        logger.exception('An Exception occured while trying to make a connection to database')
        return False
